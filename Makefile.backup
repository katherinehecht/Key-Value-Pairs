...
test:	test-unsorted test-sorted test-bst test-rbtree test-treap test-frequencies test-benchmark
...
test-frequencies: frequencies
	@echo "Testing output with frequencies.."
	@diff --suppress-common-lines -y <(./frequencies < input_beowulf.txt -b treap | sort -rn) output
